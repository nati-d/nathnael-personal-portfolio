      ...
      <Container className="relative py-20 lg:py-32">
        <div className="relative z-10 mx-auto max-w-2xl lg:max-w-5xl  p-8 sm:p-10 lg:p-12">
          ...
          <div className="mt-6 space-y-6 font-geist text-md sm:text-xl tracking-tight text-muted-foreground">
            <p>
              Welcome to my personal space. I'm passionate about creating meaningful experiences, building innovative solutions, and connecting with amazing people. Explore my work, thoughts, and journey.
            </p>
          </div>
